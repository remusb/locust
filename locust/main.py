...
from .stats import (print_error_report, print_percentile_stats, print_stats,
                    stats_printer, stats_writer, write_stat_csvs, stats_cloudwatch)
...
def parse_options():
    ...
    parser.add_option(
        '--cloudwatch',
        action='store_true',
        dest='cloudwatchstats',
        default=False,
        help="Set to export statistics to AWS CloudWatch metrics.",
    )
...
def main():
    ...
    if options.cloudwatchstats:
        gevent.spawn(stats_cloudwatch)
